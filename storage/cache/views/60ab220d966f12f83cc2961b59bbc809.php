...
<head>
    ...
    <link rel="icon" href="<?= htmlspecialchars((string)(asset('favicon.ico')), ENT_QUOTES, 'UTF-8') ?>" type="image/x-icon">
    <link rel="manifest" href="<?= htmlspecialchars((string)(url('manifest.json')), ENT_QUOTES, 'UTF-8') ?>">
